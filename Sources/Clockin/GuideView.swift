        ...
        VStack(spacing: S(0)) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: S(12)) {
                    ...
                    guideSection("4", "Keep historical rates correct", "In Settings > Pay, turn on Earlier work had a different rate and enter the change date and earlier rate. When you change the hourly rate, choose Today, Pick a date, or Always after reviewing the earnings impact. Work uses the rate for the day it started, including running sessions. Use Rate schedule for more complex periods.", "calendar.badge.plus")
                    ...
                    guideSection("8", "Focus radio", "In Settings > Focus radio, choose Radio Paradise (Main Mix), Mellow Mix, Global Mix or Serenity (ambient), then press Play. To change channels during playback, press Stop, choose a station and press Play again. Adjust radio volume in Settings. Press Stop there or use Stop focus radio in the menu bar panel. Streaming uses internet data; connection errors appear in Settings, where Play retries.", "radio")
