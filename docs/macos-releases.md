...
|---|---|---|---|
| 1.1.6 | 10 | 2026-09-16 | Premium controls across the app, the mascot as the menu-bar and header mark, and the decorative-copy cleanup. |
...
```sh
scripts/publish-mac.sh 1.1.7 --dry-run   # local rehearsal, nothing committed or published
scripts/publish-mac.sh 1.1.7             # the real release
```
