                    ...
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        if purchased {
                            ...
                            Text(item.isHomeItem ? "Try it in your room" : "Try it on")
                                .font(.title3.bold())
                            Text("Preview freely. Your items and coins stay unchanged until you choose.")
                        ...
                        if !owned {
                            ...
                            if !canChoose {
                                Text(item.unlock.price == nil ? "Unlock this item by reaching its milestone. You can still try it on." : "Keep focusing to earn more coins. You can still preview this item.")
    ...
    private var sceneOptions: some View {
        VStack(spacing: 16) {
            ...
            Picker("Companion activity", selection: $activity) {
                ...
                Text("At home").tag(Optional(CompanionHomeActivity.idle))
                if draft.furniture["desk"] != nil { Text("At the desk").tag(Optional(CompanionHomeActivity.working)) }
                if draft.furniture["floorRight"] == "bean-bag" { Text("Taking a break").tag(Optional(CompanionHomeActivity.relaxing)) }
