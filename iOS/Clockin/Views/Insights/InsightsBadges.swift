...
extension InsightsSnapshot {
    var badges: [InsightsBadge] {
        ...
        return [
            ...
            .init(id: "goal", title: "Goal setter", requirement: "Complete a daily goal", icon: "target", unlocked: goalDays >= 1, progress: String(goalDays) + " goal days"),
            .init(id: "doublegoal", title: "Double down", requirement: "Reach 2× a daily goal", icon: "arrow.up.right.circle.fill", unlocked: doubleGoalDays >= 1, progress: String(doubleGoalDays) + " double-goal days"),
            .init(id: "monthgoal", title: "Month finisher", requirement: "Complete a monthly goal", icon: "calendar.circle.fill", unlocked: goalMonths >= 1, progress: String(goalMonths) + " goal months"),
            ...
            .init(id: "goal7", title: "Goal rhythm", requirement: "Complete daily goals on 7 days", icon: "checkmark.seal.fill", unlocked: goalDays >= 7, progress: progressText(String(goalDays), "7 goal days")),
            .init(id: "goal30", title: "Goal machine", requirement: "Complete daily goals on 30 days", icon: "target", unlocked: goalDays >= 30, progress: progressText(String(goalDays), "30 goal days")),
            .init(id: "month3", title: "Quarter planner", requirement: "Complete 3 monthly goals", icon: "calendar.badge.checkmark", unlocked: goalMonths >= 3, progress: progressText(String(goalMonths), "3 goal months")),
            .init(id: "month12", title: "Year planner", requirement: "Complete 12 monthly goals", icon: "calendar.badge.clock", unlocked: goalMonths >= 12, progress: progressText(String(goalMonths), "12 goal months")),
