        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    topic("Companion moods and accessories", icon: "face.smiling",
                          detail: "Your companion follows your session on Today, in desk mode and in the medium widget. When idle after a broken streak or at least two quiet calendar days, it looks tired. Grumpy reminders keep their angry expression; Friendly uses tired for this drift. A new level, badge, daily goal or a saved session longer than two hours brings about four seconds of pride, then the usual mood returns. Achievements wait for an open sheet or alert to close. Choose an Accessory in Settings > Appearance: Auto wears your highest unlocked item, None removes it. Headphones unlock at 25h, Mug at 50h, Cape at 100h and Gold antenna at 250h, including the active session. Accessories appear only in the hello rest pose; drawn clips and hops use the plain companion. Badges > Companion shows what is unlocked and how much time remains. Already earned accessories are added silently on first use; later unlock banners open Badges. The companion moves in short bursts with quiet rests. Reduce Motion, Low Power Mode and serious or critical thermal state keep it still.")
