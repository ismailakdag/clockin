        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    topic("Companion: outfits, coins and home", icon: "face.smiling",
                          detail: "Tap the companion on Today, or open Badges > Companion, to dress it and decorate its home. The text row on Today's card opens Insights. Outfit has one item per slot and a body colorway; None removes an item. Headphones unlock at 25h, Mug at 50h, Cape at 100h and Gold antenna at 250h. Earned items stay yours. Shop purchases ask for confirmation and equip immediately. Focus coins come from completed work: 10 per hour after rounding each session down to minutes, 25 per day meeting your current daily goal, 50 per archive badge and 100 per reached level including level 1. Archive edits and goal changes recalculate the balance, which never goes below zero. Home lets you choose a room and place furniture in fixed slots. Cozy is free; Studio and Night cost coins. Settings > Show home in desk mode controls the dimmed landscape background. Your outfit follows drawn poses, moods, celebrations and the widget. A hand item hides while its hand is occupied or absent. Missing artwork stays hidden. The companion rests when offscreen, in the background, or when motion and power settings require it. Exported and automatic backups include your wardrobe, purchases and home; older backups leave your wardrobe unchanged.")
                    topic("Companion celebrations", icon: "sparkles",
                          detail: "Your companion celebrates new levels across every tab and in desk mode. Tap to dismiss, or use Share to open your stats card. Celebrations wait while a sheet or alert is open. New badge banners open Badges when tapped; several unlocks show up to three badges and a remaining count. Existing progress is marked seen when this feature first starts. During active use, playful reactions to money targets, streak milestones and session actions are limited to once every 20 seconds. Pride for achievements has its own four-second window. Goal and money reactions are checked on the next minute refresh. Reduce Motion keeps a still companion; turning Focus companion off leaves celebration text only.")
                    topic("Level and badges", icon: "rosette",
                          detail: "Open Badges, or tap your level on Today, to see your level, XP, streaks and all badges. Expand How XP works for the breakdown. Tap a badge for its requirement and current progress. Current-streak badges lock again when a streak ends.")
                } header: {
