            ...
            List {
                ...
                Section {
                    ...
                    topic("Companion celebrations", icon: "sparkles",
                          detail: "Your companion celebrates new levels across every tab and in desk mode. Tap to dismiss, or use Share to open your stats card. Celebrations wait while a sheet or alert is open. New badge banners open Badges when tapped; several unlocks show up to three badges and a remaining count. Existing progress is marked seen when this feature first starts. During active use, the visible companion can briefly react to your daily goal, money targets, streak milestones and session actions, at most once every 20 seconds. Goal and money reactions are checked on the next minute refresh. Reduce Motion keeps a still companion; turning Focus companion off leaves celebration text only.")
