...
Each packaged Mac version's matching source is tagged `macos-v<version>`, for example [macos-v1.1.3](https://github.com/ismailakdag/clockin/tree/macos-v1.1.3). The instructions below are for building from source.
